...
import dev.kierat.plugins.jmlgen.JavaFileVisitor;
import dev.kierat.plugins.jmlgen.VisitorConfiguration;
import dev.kierat.plugins.openjml.utils.generator.adapter.element.PsiTypeElementAdapter;
...
public class JMLFileGenerator extends JavaRecursiveElementVisitor {

    private final SpecBuilder specBuilder;

    public JMLFileGenerator(String packageName, JMLGenerationConfig config) {
